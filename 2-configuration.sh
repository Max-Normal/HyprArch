...
cp /HyprArch/7-nvidia.sh /home/$username
cp /HyprArch/8-apps.sh /home/$username
cp /HyprArch/9-hyprland.sh /home/$username
cp /HyprArch/10-configs.sh /home/$username
cp /HyprArch/11-kvm.sh /home/$username
...
echo "- nvidia drivers: 7-nvidia.sh"
echo "- applications: 8-apps.sh"
echo "- hyprland install: 9-hyprland.sh"
echo "- dotfiles: 10-configs.sh"
echo "- qemu virtualization: 11-kvm.sh"
